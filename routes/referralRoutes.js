...
router.get('/stats', auth, async (req, res) => {
  try {
    ...
    const referrals = await Referral.find({ referrer: user._id }).populate('referred', 'username');

    const stats = {
      totalReferrals: user.referrals.length,
      totalReferralXP: user.totalReferralXP,
      primaryReferralXP: user.primaryReferralXP,
      secondaryReferralXP: user.secondaryReferralXP,
      tertiaryReferralXP: user.tertiaryReferralXP,
